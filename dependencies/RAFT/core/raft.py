...
from core.utils.utils import bilinear_sampler, coords_grid, upflow8, InputPadder, coords_grid2
...
class RAFT2(nn.Module):
    ...
    def forward(self, image1, image2):
        ...
        flow_up, _ = self.upsample_data(flow_8x, info_8x, weight_update)
