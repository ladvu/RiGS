#!/bin/bash
PROJ_NAME=TPGS
EXP_NAME=iphone_longer_no_transient_new_new_new_2
...
sbatch /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/chenyuwu/project/TPGS/scripts/iphone/reconstruct_iphone_v2.sh $PROJ_DIR $EXP_NAME